...
<html lang="en">
	<head>
		...
		<title>Xử lý sửa bài viết -  Trang Tin Tức</title>
	</head>
	<body>
		<div class="main">
			<!-- Menu: sử dụng navbar -->
			...
			<div class="card mt-3">
				<div class="card-header">Xử lý sửa bài viết</div>
				<div class="card-body">
					<div id="HienThi"></div>
				</div>
			</div>
		...
		<script type="module">
			...
			await updateDoc(doc(db, 'baiviet', '<?php echo str_pad($_POST['MaBaiViet'], 10 , '0', STR_PAD_LEFT); ?>'), {
